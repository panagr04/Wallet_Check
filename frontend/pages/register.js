...
import {register as userRegister} from "../api/services"
...
export default function Home() {
  ...
  const onSubmit = (data) => {
		let reuult = userRegister(data,router)
	}
  ...
  <div className="flex-col justify-around hero-content lg:flex-row w-full">
    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
		...
		<h1 className=" mb-5 text-5xl font-bold text-neutral-content">Sign Up</h1>
...
{errors.name?.type === 'required' && <div className="badge badge-error">Required</div>}
          </label>
          <input
            type="text"
          ...
          <label className="label flex justify-between items-center flex-wrap">
            <span className="label-text">Contact </span>
						{errors.contact?.type === 'required' && <div className="badge badge-error">Required</div>}
          </label>
          <input
            type="text"
	...
	<label className="cursor-pointer label">
		<input type="radio" name="gender"  {...register("gender")} checked className="radio radio-accent" value="Male"/>
		<span className="ml-2 label-text">Male</span> 
	</label>
</div> 
<div className="form-control">
	<label className="cursor-pointer label">
		<input type="radio" name="gender"  {...register("gender")} className="radio radio-accent" value="Female"/>
		<span className="ml-2 label-text">Female</span> 
	</label>
</div>
<div className="form-control">
	<label className="cursor-pointer label">
		<input type="radio" name="gender"  {...register("gender")} className="radio radio-accent" value="Others"/>
		<span className="ml-2 label-text">Others</span> 
	</label>
</div>
									</div>
        </div>
          ...
          <label className="label flex justify-between items-center flex-wrap">
            <span className="label-text">Date of Birth  </span>
						{errors.dob?.type === 'required' && <div className="badge badge-error">Required</div>}
          </label>
          <input
            type="date"
						{...register("dob",{ required: true})}
            placeholder="15/07/1999"
            className="input input-bordered"
          />
        </div>
				<div className="form-control">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
		...
		<h1 className="mb-5 text-3xl font-bold">👋 Hi ! We are so happy to see you join us</h1>
